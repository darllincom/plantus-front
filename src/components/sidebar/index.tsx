...
import PlantusHeader from '../plantus-header';
      ...
      "
		>
          ...
          `}
				...
				>
					<Icons
						name={IconNames.EQUIPE}
						size={'sm'}
						selected={selected === 'equipe'}
					/>
