			...
			{isLoading ? (
				...
				<>
							...
							<div className="h-full w-52 lg:w-[25%] rounded-2xl bg-dark-green flex items-center content-start justify-start flex-col py-4">
								<div className="relative">
									...
									<div className="absolute bottom-0 -right-2 w-5 h-5 rounded-full bg-white border-light-green border-2">
										{userProfile.hasRegisteringPending ? (
											<svg
												viewBox="0 0 33 32"
												fill="none"
								...
								<span className="bg-base-green text-white px-10 my-5 rounded-full text-sm lg:text-lg lg:px-20">
									{userProfile.office}
								</span>
								<span className="bg-base-green text-white px-10 rounded-full text-sm lg:text-lg lg:px-20">
                  ...
                  <fieldset className="relative w-full my-2 lg:mt-4 lg:w-[48%] lg:mr-4">
                      ...
                      lg:text-base"
											>
												{new Date(userProfile.dateStarted).toLocaleDateString()}
											</p>
											<label
												className="
                        absolute left-4 -top-2 z-20
